...
class HomeBpCard extends StatefulWidget {
  const HomeBpCard({super.key});

  @override
  State<HomeBpCard> createState() => _HomeBpCardState();
}

class _HomeBpCardState extends State<HomeBpCard> {
  @override
  Widget build(BuildContext context) {
    final viewModel = context.read<HomeViewmodel>();
    final BPRecord(:sys, :dia, :pulse, :createdAt) = viewModel.latestRecord!;
